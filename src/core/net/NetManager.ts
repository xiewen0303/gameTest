module net {
	export class NetManager {
		...
		public static getNetManager():NetManager{
		...
		private createClazz(resName:string,messageName:string):any{
			let proto:string = RES.getRes(resName);
			let builder:any = dcodeIO.ProtoBuf.loadProto(proto,"resource/proto/");
			let clazz:any = builder.build(messageName);
			return clazz;
		}
